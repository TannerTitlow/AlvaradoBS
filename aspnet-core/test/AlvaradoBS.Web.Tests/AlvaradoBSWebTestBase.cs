...
{
    public abstract class AlvaradoBSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AlvaradoBSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AlvaradoBSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AlvaradoBSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AlvaradoBSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AlvaradoBSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AlvaradoBSDbContext, Task<T>> func)
        {
            T result;
